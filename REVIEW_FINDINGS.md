...
- [ ] **L35. Clean-room install verification.** Re-verify the GitHub Release wheel install end-to-end from an empty environment before beta (RELEASE_READINESS_REVIEW.md found the v0.1.0 release missing on 2026-04-25). Includes folding CHANGELOG `[Unreleased]` into the released version or bumping.

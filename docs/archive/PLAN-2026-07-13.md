# Archived plan — through 2026-07-13

> **Historical record.** This was the working plan through 2026-07-13. It
> preserves shipped phases, audit narratives, and the planning context that
> produced qdo 0.2.0. It is not a current task list. See [the active
> plan](../../PLAN.md) for current commitments.

Links below are preserved as part of the original record and may point to
